    ...
    >
        ...
        <div class="sb" :class="{ show: sidebarOpen }">
            ...
            <div class="sb-nav">
                ...
                >
                <a href="/coordinador/comunidades" class="sb-lnk active"
                    ...
                    <div class="table-responsive">
                        <table class="ct">
                            ...
                            <tbody>
                                ...
                                <tr v-for="com in paginadas" :key="com.com_id">
        ...
        <div class="modal fade" id="mCom" tabindex="-1">
                ...
                <div class="modal-content border-0 shadow-lg">
                    <div class="modal-body text-center p-4">
                        ...
                        >
                            ...
                            <strong>{{ itemAEliminar?.com_nombre }}</strong
                            >?
                        </p>
                    </div>
                    <div
...
const props = defineProps({ comunidades: Array, tiposOrganizacion: Array });
const page = usePage();
...
const filtradas = computed(() => {
    if (!busqueda.value.trim()) return props.comunidades;
    const q = busqueda.value.toLowerCase();
    return props.comunidades.filter(
        (c) =>
            c.com_nombre.toLowerCase().includes(q) ||
            c.com_ubicacion?.toLowerCase().includes(q),
    );
});
...
const abrirModal = (com = null) => {
    ...
    errores.value = {};
    modal = modal || new Modal(document.getElementById("mCom"));
    modal.show();
};
const guardar = () => {
    loading.value = true;
