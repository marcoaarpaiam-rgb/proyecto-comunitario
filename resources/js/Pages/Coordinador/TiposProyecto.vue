    ...
    >
        ...
        <div class="sb" :class="{ show: sidebarOpen }">
            ...
            <div class="sb-nav">
                ...
                <a href="/coordinador/tipos-proyecto" class="sb-lnk active"
        ...
        <div class="main">
            <div class="topbar">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="tb-title">
                        <i
                            class="bi bi-tag me-2 text-danger d-none d-sm-inline"
                        ></i
                        >Tipos de Proyecto
                    </div>
                </div>
                ...
                <div class="sc">
                    ...
                    >
                        ...
                        <span
                            style="
                                ...
                                font-weight: 600;
                            "
                            >{{ tiposFiltrados.length }} resultado(s)</span
                        >
                    </div>
                    <div class="table-responsive">
                        <table class="ct">
                            ...
                            <tbody>
                                ...
                                <tr v-for="t in tiposPaginados" :key="t.tpr_id">
                                    <td
                                        class="ps-4"
                                        style="
                                            color: var(--text-muted);
                    ...
                    >
                        <span
                            ...
                            >{{ desde + 1 }}–{{
                                Math.min(hasta, tiposFiltrados.length)
                            }}
                            de {{ tiposFiltrados.length }}</span
                        >
        ...
        <div class="modal fade" id="mTipo" tabindex="-1">
                    ...
                    <form @submit.prevent="guardar">
                        <div class="modal-body">
                            ...
                            <input
                                ...
                                type="text"
                                class="form-control"
                                :class="{ 'is-invalid': errores.tpr_nombre }"
                ...
                <div class="modal-content border-0 shadow-lg">
                    <div class="modal-body text-center p-4">
                        ...
                        >
                            ...
                            <strong>{{ itemAEliminar?.tpr_nombre }}</strong
                            >?
                        </p>
                    </div>
                    <div
...
const tiposFiltrados = computed(() => {
    if (!busqueda.value.trim()) return props.tipos;
    const q = busqueda.value.toLowerCase();
    return props.tipos.filter((t) => t.tpr_nombre.toLowerCase().includes(q));
});
const totalPaginas = computed(() =>
    Math.ceil(tiposFiltrados.value.length / porPagina),
);
const desde = computed(() => (pagina.value - 1) * porPagina);
const hasta = computed(() => desde.value + porPagina);
const tiposPaginados = computed(() =>
    tiposFiltrados.value.slice(desde.value, hasta.value),
);
...
const abrirModal = (tipo = null) => {
    ...
    errores.value = {};
    modal = modal || new Modal(document.getElementById("mTipo"));
    modal.show();
};
const guardar = () => {
    loading.value = true;
