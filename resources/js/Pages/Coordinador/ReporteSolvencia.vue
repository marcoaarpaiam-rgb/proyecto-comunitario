        ...
        <div class="main">
            <div class="topbar">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="tb-title">
                        <i
                            class="bi bi-person-check me-2 text-danger d-none d-sm-inline"
                        ></i
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    >
                    <a
                        :href="`/coordinador/reportes/exportar-solvencia?sec_id=${seccion.sec_id}`"
                        target="_blank"
            ...
            <div class="content">
                ...
                <div v-if="!reporte?.length" class="sc">
                    <div
                ...
                <div v-for="equ in reporte" :key="equ.equipo" class="sc">
                    <div class="sh">
                        <div>
                            <span
                                style="
...
const props = defineProps({ seccion: Object, reporte: Array });
const page = usePage();
